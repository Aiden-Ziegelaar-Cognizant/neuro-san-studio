...
class GetDataloggers(CodedTool):
    def __init__(self):
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        self.tailings_db.execute(f"SELECT serial_number FROM dataloggers WHERE site_id = (SELECT site_id FROM sites WHERE site_name = ?)", [site_name])
        # return sites
        return {
            "dataloggers": self.tailings_db.fetchall()
        }
